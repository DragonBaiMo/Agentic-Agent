---
name: agent-rules
description: "MUST load on every task. Core engineering rules bundle: context engineering, todo management, development environment, code quality (general + language-specific: python, typescript, java, sql), UI design."
---
