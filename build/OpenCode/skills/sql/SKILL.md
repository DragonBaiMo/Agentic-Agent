---
name: sql
description: "SQL 专属编码规范。强制使用 ANSI/ISO 标准 SQL，禁止数据库方言特有语法。覆盖标准化语法替代、格式、命名、JOIN、安全。通用规范见 code-quality.instructions.md。 Use when editing files matching: **/*.sql"
---
