---
name: typescript
description: "TypeScript / JavaScript 专属编码规范。覆盖模块结构、类型安全、导入规则、禁止模式。通用规范见 code-quality.instructions.md。 Use when editing files matching: **/*.ts, **/*.tsx, **/*.js, **/*.jsx, **/*.vue, **/*.svelte"
---
